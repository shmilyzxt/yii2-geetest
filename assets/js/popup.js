/**
 * Created by zhenxiaotao on 2016/8/26.
 */
$(function () {
    // 验证开始需要向网站主后台获取id，challenge，success（是否启用failback）
    $.ajax({
        url: "index.php?r=geetest/geetest/startcaptchaservlet&type=pc&t=" + (new Date()).getTime(), // 加随机数防止缓存
        type: "get",
        dataType: "json",
    ...
    var handlerPopup = function (captchaObj) {
        ...
        captchaObj.onSuccess(function () {
            ...
            $.ajax({
                url: "index.php?r=geetest/geetest/verifyloginservlet", // 进行二次验证
                type: "post",
                dataType: "json",
                data: {
                    type: "pc",
